...
class MonsterNameSprite ( pygame.sprite.Sprite ):
	...
	def __init__( self, entity: Trainers, monster: Monster, monster_rect: FRect, font: Font, *groups: MyGroup ) -> None:
		...
		self.rect = self.image.get_frect(midright=monster_rect.midleft + vector(40, -70)) if self.entity == 'player' else self.image.get_frect(midleft=monster_rect.midright + vector(-40, -70))
